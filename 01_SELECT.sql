...
-- EMPLOYEE 테이블에서 모든 사원의 사번, 급여, 연봉(급여*12) 조회
...
-- 주의사랑 2) DISTINCT 구문은 SELECT 제일 앞에 작성되어야 한다.
...
-- EMPLOYEE 테이블에서 입사일이 1990-01-01 ~ 1999-12-31 사이의 직원이
-- 이름, 입사일 조회
